...
\begin{frame}{Possible Realizations}
  ...
  \vspace*{5mm}
  \hfill \includegraphics[height=10mm]{\figs/disk1} \hspace*{10mm}
...
\begin{frame}{Membership of the Virtual Organization ``ILDG''}
  ...
  \begin{center}
    ...
    \hspace*{-10mm}
    \fbox{\includegraphics[height=15mm]{\figs/screen-voms}}
  \end{center}
...
\begin{frame}{Membership of the Virtual Organization ``ILDG''}
  ...
  \begin{center}
    ...
    \hspace*{19mm}
    \fbox{\includegraphics[height=20mm]{\figs/screen-iam}}
  \end{center}
